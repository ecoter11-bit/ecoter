...
excerpt: Formazione specifica obbligatoria per lavoratori in attività a rischio basso, ai sensi di D.Lgs 81/08 art. 36-37, della durata di 4 ore.
code: A02
category: sicurezza
level: base
modality:
...
curriculum:
  - title: Formazione Specifica (4 ore)
    topics:
...
_Fonte: Accordo Stato-Regioni del 17 aprile 2025 (rep. atti n. 59/CSR), Allegato A, Parte II, §2.1 — Corso per lavoratori, Formazione Specifica (4 ore, classe di rischio basso)._
